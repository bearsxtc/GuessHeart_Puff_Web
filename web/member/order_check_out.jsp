...
<html>
    ...
    <body onresize="changeSize()">
        ...
        <div id="article">
            ...
            <div id="main">
                <div class="ch">
                    <form method="POST" action="order_check_out.do">                
                        <div class="list" style="width:60%; min-width: 500px; margin: 0 auto;">
                            <table style="width: 90%;margin: auto">
                                ...
                                <tr>
                                    ...
                                    <td><%= order_cart.getQuantity(item)%></td>
                        ...
                        <div class="check_out" style="width: 80%; ">
                            <h4 style="text-align: right" >總金額： <small>NT$</small><span style="color: red;font-size: larger; font-weight: 900"><%= order_cart.getTotalAmount()%></span>元</h4>
                        </div>
